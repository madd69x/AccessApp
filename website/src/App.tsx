  ...
  return (
    <div className="w-full relative pointer-events-none text-[#FFFFFF] selection:bg-white selection:text-black font-['Inter']">
      ...
      >
        ...
        <h2 className="text-2xl md:text-3xl font-['Sora'] font-medium uppercase tracking-widest text-[#CCCCCC] mb-8">
      ...
      >
        <h2 className="text-4xl md:text-6xl font-['Sora'] font-bold tracking-tight text-white mb-10">
          The Scale of the Problem.
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 w-full">
          <div className="bg-[#0A0A0A]/90 backdrop-blur-md border border-[#333336] p-6 rounded-2xl shadow-xl">
            <h4 className="text-3xl font-['Sora'] font-extrabold text-white mb-2">26.8M+</h4>
            <p className="text-[#A3A3A3] text-xs font-semibold uppercase tracking-wider">Persons with disabilities in India</p>
          </div>
          <div className="bg-[#0A0A0A]/90 backdrop-blur-md border border-[#333336] p-6 rounded-2xl shadow-xl">
            <h4 className="text-3xl font-['Sora'] font-extrabold text-white mb-2">1-2%</h4>
            <p className="text-[#A3A3A3] text-xs font-semibold uppercase tracking-wider">Educational content is accessible</p>
          </div>
          <div className="bg-[#0A0A0A]/90 backdrop-blur-md border border-[#333336] p-6 rounded-2xl shadow-xl">
            <h4 className="text-3xl font-['Sora'] font-extrabold text-white mb-2">3x</h4>
            <p className="text-[#A3A3A3] text-xs font-semibold uppercase tracking-wider">Higher dropout rates</p>
          </div>
          <div className="bg-[#0A0A0A]/90 backdrop-blur-md border border-[#333336] p-6 rounded-2xl shadow-xl">
            <h4 className="text-3xl font-['Sora'] font-extrabold text-white mb-2">13M</h4>
            <p className="text-[#A3A3A3] text-xs font-semibold uppercase tracking-wider">Visually & hearing impaired</p>
          </div>
        </div>
        <p className="text-lg text-[#A3A3A3] font-normal leading-relaxed max-w-4xl mx-auto text-center">
      ...
      >
        <SecurityIcon />
        <h2 className="text-4xl md:text-6xl font-['Sora'] font-bold tracking-tight text-white mb-6">
          100% On-Device Processing.
        </h2>
        <h3 className="text-xl md:text-2xl font-['Sora'] text-white font-semibold uppercase tracking-widest mb-6">Zero latency. Zero data collection.</h3>
        <p className="text-lg md:text-xl font-normal text-[#86868B] leading-relaxed max-w-4xl mx-auto">
        ...
        <p className="text-lg font-normal text-[#86868B] leading-relaxed max-w-4xl mx-auto mt-4">
      ...
      >
        ...
        <p className="text-lg text-[#A3A3A3] font-['Sora'] uppercase tracking-widest text-center mb-16 max-w-3xl mx-auto font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pointer-events-auto">
          ...
          <div className="uiverse-glow-card bg-[#0A0A0A]/90 backdrop-blur-xl border-none p-8 rounded-2xl transition-all duration-500 group shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            ...
            <ul className="text-sm text-[#A3A3A3] font-normal leading-relaxed border-t border-[#333336] pt-4 list-disc pl-5 space-y-1">
              <li><strong className="text-white">Dynamic Haptic Feedback:</strong> Vibrates dynamically based on proximity.</li>
          ...
          <div className="uiverse-glow-card bg-[#0A0A0A]/90 backdrop-blur-xl border-none p-8 rounded-2xl transition-all duration-500 group shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            ...
            <ul className="text-sm text-[#A3A3A3] font-normal leading-relaxed border-t border-[#333336] pt-4 list-disc pl-5 space-y-1">
              <li><strong className="text-white">Auto-Language Detection:</strong> Detects Latin and Devanagari natively.</li>
              <li><strong className="text-white">Instant TTS:</strong> Converts text into fluid speech instantly.</li>
            </ul>
          </div>
          ...
          <div className="uiverse-glow-card bg-[#0A0A0A]/90 backdrop-blur-xl border-none p-8 rounded-2xl transition-all duration-500 group shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            ...
            <p className="text-sm text-[#A3A3A3] font-normal leading-relaxed border-t border-[#333336] pt-4">
              Translates live camera feeds into English text for seamless communication bridging, improving interactivity.
            </p>
          </div>
          ...
          <div className="uiverse-glow-card bg-[#0A0A0A]/90 backdrop-blur-xl border-none p-8 rounded-2xl transition-all duration-500 group shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            ...
            <p className="text-sm text-[#A3A3A3] font-normal leading-relaxed border-t border-[#333336] pt-4">
              Converts raw values into human-readable color names to assist visually impaired users.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pointer-events-auto">
          ...
          <div className="uiverse-glow-card bg-[#0A0A0A]/90 backdrop-blur-xl border-none p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            ...
            <ul className="text-sm text-[#CCCCCC] font-normal leading-relaxed space-y-4">
              <li><strong className="text-white">Kinetic Feedback:</strong> Employs the Compose <code>spring()</code> physics engine for physical weight and momentum.</li>
              <li><strong className="text-white">Auditory Cues:</strong> Comprehensive system audio feedback for state changes.</li>
              <li><strong className="text-white">Contrast & Legibility:</strong> Calibrated palette designed exclusively for maximal readability.</li>
            </ul>
          </div>
          ...
          <div className="uiverse-glow-card bg-[#0A0A0A]/90 backdrop-blur-xl border-none p-8 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
            ...
            <ul className="text-sm text-[#CCCCCC] font-normal leading-relaxed space-y-2 border-l-2 border-[#333336] pl-4">
...
// Premium Full-Width Glassmorphic Header Component
const Header = () => (
  <header className="fixed top-0 left-0 w-full px-8 py-5 flex justify-between items-center z-50 bg-[#000000]/30 backdrop-blur-[40px] border-b border-white/10 font-['Sora'] text-white">
    <div className="flex items-center gap-4">
      <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-white to-[#666666] flex items-center justify-center">
        <svg className="w-4 h-4 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
      </div>
      <span className="text-xl font-extrabold uppercase tracking-widest">AccessApp</span>
    </div>
    <div className="hidden md:flex items-center gap-10 text-xs font-semibold uppercase tracking-[0.2em] text-[#A3A3A3]">
    ...
    <a 
      ...
      target="_blank" 
      rel="noreferrer"
      className="uiverse-shimmer-btn bg-white text-black px-8 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#E5E5EA] transition-colors shadow-[0_0_20px_rgba(255,255,255,0.2)]"
    >
      Download
    </a>
  </header>
